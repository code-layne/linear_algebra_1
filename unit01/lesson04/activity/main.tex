%! Matrix Multiplication and A = CR — Unit 1, Lesson 1.4 — Group Activity
...
\end{work}
  \item Show product~3 is a bundle: find weights so $\begin{bsmallmatrix} 4\\5 \end{bsmallmatrix}
        = \blank{0.7cm}\begin{bsmallmatrix} 1\\2 \end{bsmallmatrix} + \blank{0.7cm}\begin{bsmallmatrix} 2\\1 \end{bsmallmatrix}$.
        Use them to write $R$.
\begin{work}
