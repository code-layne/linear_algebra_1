...
\begin{enumerate}[leftmargin=1.6em]
  ...
  \item Solve $A\xx=\bb$ using $\PP A\xx=\PP\bb$. \hfill $x=\ans{$1$}$\quad $y=\ans{$1$}$
        \ansline{$\PP\bb=\begin{bsmallmatrix} 8\\4 \end{bsmallmatrix}$; $L=I$, so $U\xx=\PP\bb$: $4y=4\Rightarrow y=1$, $2x+6=8\Rightarrow x=1$.}
  \item Write $A^{\tp}$. Is $A$ symmetric?
        \ansline{$A^{\tp}=\begin{bsmallmatrix} 0&2\\4&6 \end{bsmallmatrix}$. Not symmetric --- the off-diagonal entries $4$ and $2$ differ.}
\end{enumerate}
\end{practicebox}
