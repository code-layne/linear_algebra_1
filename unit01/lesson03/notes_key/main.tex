...
\begin{enumerate}[leftmargin=1.6em]
  \item Compute $A\begin{bmatrix} 1 \\ 2 \end{bmatrix}$ as a combination of the columns. \hfill \ans{$1\begin{bsmallmatrix} 1\\3 \end{bsmallmatrix}+2\begin{bsmallmatrix} 2\\1 \end{bsmallmatrix}=\begin{bsmallmatrix} 5\\5 \end{bsmallmatrix}$}
