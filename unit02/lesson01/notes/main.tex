...
\begin{enumerate}[leftmargin=1.6em]
  ...
  \item Do the elimination step to reach upper-triangular form, and find $y$. \writeline
  \item Back-substitute to find $x$, then \textbf{check} by rebuilding $\bb$. \writeline
\end{enumerate}
\end{practicebox}
