...
\begin{enumerate}[leftmargin=1.7em, itemsep=8pt]
  \item $\vv + \ww$ \ans{$\begin{bmatrix} 3 \\ 4 \end{bmatrix}$, i.e.\ the point $(3,4)$}
  \item $2\vv$ (use move $\vv$ twice) \ans{$\begin{bmatrix} 4 \\ 2 \end{bmatrix}$, i.e.\ $(4,2)$}
  \item $\vv - \ww$ \ans{$\begin{bmatrix} 1 \\ -2 \end{bmatrix}$, i.e.\ $(1,-2)$}
...
\begin{enumerate}[leftmargin=1.7em, itemsep=8pt]
  \item Find weights $c$ and $d$ so the robot lands on $(7,6)$: solve $c\,\vv + d\,\ww =
        ...
        \ansline{$2c+d=7,\ c+3d=6 \Rightarrow c=3,\ d=1$; check $3\vv+\ww=(6,3)+(1,3)=(7,6)$.}
