...
\begin{enumerate}[leftmargin=1.7em, itemsep=9pt]
  ...
  \item Multiply $E_{21}A$ to reach upper-triangular $U$. \vspace{1.3cm}
...
\begin{enumerate}[leftmargin=1.7em, itemsep=8pt]
  \item Build the machine once: compute $ad-bc$ and write $A^{-1}$. \vspace{1.1cm}
  \item \textbf{Monday's order:} $8$ mugs, $11$ candles. Use $\xx=A^{-1}\bb$ to find $s$ and $t$. \vspace{1.1cm}
  \item \textbf{Tuesday's order:} $10$ mugs, $14$ candles. Same machine --- find $s$ and $t$. \vspace{1.1cm}
...
to the zero-pivot breakdown from Lesson~2.1. \writelines{3}
\end{tcolorbox}
