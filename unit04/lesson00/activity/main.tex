%! Right Angles Revisited --- Setting Up Orthogonality — Unit 4, Lesson 4.0 — Group Activity
...
\begin{enumerate}[leftmargin=1.7em, itemsep=8pt]
  \item Compute the dot product
        ...
        = \blank{2.2cm}$. Is the angle acute, right, or obtuse? \; \blank{2.2cm}
  \item Find the length and unit vector of $\begin{bsmallmatrix} 8\\6 \end{bsmallmatrix}$:
        \quad $\|\cdot\| = \blank{1.6cm}$, \quad
        unit vector $= \begin{bmatrix}\rule{0pt}{1.0em}\blank{1.0cm}\\[2pt]\blank{1.0cm}\end{bmatrix}$.
  \item Are $\begin{bsmallmatrix} 2\\6 \end{bsmallmatrix}$ and $\begin{bsmallmatrix} 3\\-1 \end{bsmallmatrix}$
        perpendicular? Compute the dot product and decide. \; \blank{3.0cm}
\end{enumerate}
\end{tcolorbox}
...
\begin{enumerate}[leftmargin=1.7em, itemsep=9pt]
  \item \textbf{Solve for the entry.} Find $x$ so that $\begin{bsmallmatrix} 6\\x \end{bsmallmatrix}$
        is perpendicular to $\begin{bsmallmatrix} 2\\-3 \end{bsmallmatrix}$. \writelines{2}
  \item \textbf{Build one.} Give a nonzero vector perpendicular to
        ...
        (Hint: swap the entries and negate one.) \writelines{2}
  \item \textbf{The §3.6 pairing.} Let $A=\begin{bmatrix} 1 & 3 \\ 2 & 6 \end{bmatrix}$. Its
        ...
        say about the angle between the nullspace and the rows? \writelines{2}
\end{enumerate}
\end{tcolorbox}
...
\begin{enumerate}[leftmargin=1.7em, itemsep=9pt]
  \item Set the error perpendicular to $\avec$: write the equation $\avec\cdot(\bb-t\avec)=0$, then expand
        it to $\avec\cdot\bb - t\,(\avec\cdot\avec)=0$. \writelines{2}
  ...
  \item Find the projection $\pp=t\avec$ and the error $\bb-\pp$, then \emph{check} that
        $\avec\cdot(\bb-\pp)=0$. This formula is Lesson~4.2. \writelines{2}
\end{enumerate}
\end{tcolorbox}
