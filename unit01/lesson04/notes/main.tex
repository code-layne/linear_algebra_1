...
\begin{enumerate}[leftmargin=1.6em]
  \item Multiply by columns: $\begin{bmatrix} 1 & 0 \\ 3 & 1 \end{bmatrix}\begin{bmatrix} 2 & 1 \\ 1 & 4 \end{bmatrix}$. \hfill \blank{3.4cm}
  \item Factor $A=\begin{bmatrix} 1 & 2 & 3 \\ 0 & 1 & 1 \end{bmatrix}$ as $A=CR$. Which columns are
        independent? Write $C$ and $R$, and give the rank. \writelines{2}
