...
\begin{enumerate}[leftmargin=1.9em, itemsep=10pt]
  \item \textbf{Factor.} For each $A$, name the pivot and multiplier $\ell$, then write $L$ and $U$.
    ...
    \end{enumerate}
\begin{work}
  \text{(a)}\ \text{pivot } 1,\ \ell=2:\quad U &= \begin{bsmallmatrix} 1&5\\0&2 \end{bsmallmatrix},\quad
      L = \begin{bsmallmatrix} 1&0\\2&1 \end{bsmallmatrix} \\
  \text{(b)}\ \text{pivot } 2,\ \ell=4:\quad U &= \begin{bsmallmatrix} 2&3\\0&3 \end{bsmallmatrix},\quad
      L = \begin{bsmallmatrix} 1&0\\4&1 \end{bsmallmatrix}
\end{work}
  \item \textbf{Check.} For both matrices in Problem~1, multiply $LU$ and confirm you get back $A$.
\begin{work}
  \text{(a)}\ \begin{bsmallmatrix} 1&0\\2&1 \end{bsmallmatrix}\begin{bsmallmatrix} 1&5\\0&2 \end{bsmallmatrix}
      &= \begin{bsmallmatrix} 1&5\\2&12 \end{bsmallmatrix} = A \\
  \text{(b)}\ \begin{bsmallmatrix} 1&0\\4&1 \end{bsmallmatrix}\begin{bsmallmatrix} 2&3\\0&3 \end{bsmallmatrix}
      &= \begin{bsmallmatrix} 2&3\\8&15 \end{bsmallmatrix} = A \ \ \text{\checkmark}
\end{work}
...
\begin{work}
  \ell=4:\quad U &= \begin{bsmallmatrix} 1&2\\0&1 \end{bsmallmatrix},\quad
      L = \begin{bsmallmatrix} 1&0\\4&1 \end{bsmallmatrix} \\
  \cc &= \begin{bsmallmatrix} 3\\2 \end{bsmallmatrix} \\
  y &= 2 \\
  x+4 &= 3,\ x = -1
\end{work}
  \item \textbf{Juice bar --- one factorization, two batches.} Each liter of \textbf{Mix P} carries $1$
    ...
    \begin{enumerate}[label=(\alph*), leftmargin=1.8em, itemsep=6pt]
      \item Factor $A=LU$ once.
\begin{work}
  \ell=2:\quad U &= \begin{bsmallmatrix} 1&2\\0&2 \end{bsmallmatrix},\quad
      L = \begin{bsmallmatrix} 1&0\\2&1 \end{bsmallmatrix}
\end{work}
      \item \textbf{Batch 1:} sugar $5$, vitamin $12$. Two sweeps --- find $p,q$.
\begin{work}
  \cc &= \begin{bsmallmatrix} 5\\2 \end{bsmallmatrix} \\
  2q &= 2,\ q = 1 \\
  p+2 &= 5,\ p = 3
\end{work}
      \item \textbf{Batch 2:} sugar $8$, vitamin $22$. Same $L,U$ --- find $p,q$.
\begin{work}
  \cc &= \begin{bsmallmatrix} 8\\6 \end{bsmallmatrix} \\
  2q &= 6,\ q = 3 \\
  p+6 &= 8,\ p = 2
\end{work}
...
\begin{work}
  \ell_{21}=3,\ \ell_{31} &= 1,\ \ell_{32} = 2 \\
  U &= \begin{bsmallmatrix} 1&1&2\\0&2&1\\0&0&1 \end{bsmallmatrix},\quad
      L = \begin{bsmallmatrix} 1&0&0\\3&1&0\\1&2&1 \end{bsmallmatrix} \\
  \cc &= \begin{bsmallmatrix} 5\\5\\1 \end{bsmallmatrix} \\
  z &= 1,\ y = 2,\ x = 1
\end{work}
...
\begin{work}
  \begin{bsmallmatrix} 1&0&0\\3&1&0\\0&0&1 \end{bsmallmatrix}
  \begin{bsmallmatrix} 1&0&0\\0&1&0\\1&0&1 \end{bsmallmatrix}
  \begin{bsmallmatrix} 1&0&0\\0&1&0\\0&2&1 \end{bsmallmatrix}
      &= \begin{bsmallmatrix} 1&0&0\\3&1&0\\1&2&1 \end{bsmallmatrix} = L
\end{work}
\ansline{Each multiplier drops into its own position with nothing overlapping; $L$ and $U$ come
free from the elimination you already ran, while $A^{-1}$ takes a whole extra reduction.}
\end{extensionbox}
