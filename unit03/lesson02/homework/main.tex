%! The Nullspace of A: Solving Ax = 0 — Unit 3, Lesson 3.2 — Homework
...
\begin{enumerate}[leftmargin=1.9em, itemsep=11pt]
  \item \textbf{Find $N(A)$.} For each matrix, reduce it, give the special solution(s), and describe
    ...
    \begin{enumerate}[label=(\alph*), leftmargin=1.8em, itemsep=6pt]
      \item $A=\begin{bmatrix} 1 & 2 \\ 3 & 6 \end{bmatrix}$ \vspace{0.9cm}
      \item $A=\begin{bmatrix} 1 & 2 \\ 3 & 5 \end{bmatrix}$ \vspace{0.9cm}
      \item $A=\begin{bmatrix} 1 & 1 & 3 \\ 2 & 2 & 6 \end{bmatrix}$ \vspace{1.1cm}
      \item $A=\begin{bmatrix} 1 & 0 & 2 \\ 0 & 1 & 3 \end{bmatrix}$ \vspace{1.1cm}
    \end{enumerate}
  \item \textbf{Count without solving.} State the number of free variables and the dimension of $N(A)$.
    \begin{enumerate}[label=(\alph*), leftmargin=1.8em, itemsep=4pt]
      ...
      \item $A$ has $5$ columns and rank $r=2$. \hfill
    \end{enumerate}
    \vspace{0.9cm}
  \item \textbf{A nullspace vector is a dependency.} Show $\xx=\begin{bsmallmatrix} 2\\-1\\0 \end{bsmallmatrix}$
        ...
        tells you about the \emph{columns} of $A$. \writelines{2}
  \item \textbf{Explain.} Why does $N(A)$ live in $\mathbb{R}^n$ (columns) while $C(A)$ lives in
        $\mathbb{R}^m$ (rows)? Use a $2\times3$ matrix to make the point concrete. \writelines{2}
\end{enumerate}
\end{notesbox}
