...
\begin{enumerate}[leftmargin=1.6em]
  ...
  \item Do the elimination step to reach upper-triangular form, and find $y$.
        \ansline{row~2 $-\,2\cdot$row~1: $(6x+7y)-2(3x+2y)=19-16\Rightarrow 3y=3\Rightarrow y=1$}
  \item Back-substitute to find $x$, then \textbf{check} by rebuilding $\bb$.
        \ansline{$3x+2=8\Rightarrow x=2$; check: $2\begin{bsmallmatrix} 3\\6 \end{bsmallmatrix}+1\begin{bsmallmatrix} 2\\7 \end{bsmallmatrix}=\begin{bsmallmatrix} 8\\19 \end{bsmallmatrix}$ \checkmark}
\end{enumerate}
\end{practicebox}
