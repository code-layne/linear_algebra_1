...
\begin{enumerate}[leftmargin=1.6em]
  ...
  \item Eliminate $x_1$ (subtract twice the first equation from the second) and find $x_2$.
        \ansline{$(2x_1+3x_2)-2(x_1+x_2)=13-10 \Rightarrow x_2=3$}
  \item Back-substitute to find $x_1$, then \textbf{check} by rebuilding $\bb$.
        \ansline{$x_1=5-3=2$;\ \ check: $2\begin{bsmallmatrix} 1\\2 \end{bsmallmatrix}+3\begin{bsmallmatrix} 1\\3 \end{bsmallmatrix}=\begin{bsmallmatrix} 5\\13 \end{bsmallmatrix}$ \checkmark}
\end{enumerate}
\end{practicebox}
