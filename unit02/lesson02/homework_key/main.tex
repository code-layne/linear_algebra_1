...
\end{work}
        \ansline{The formula fails and elimination hits a zero pivot, so $A$ is singular --- no inverse.}
\end{enumerate}
\end{notesbox}
...
\end{work}
\ansline{The multipliers $2$ and $5$ slot straight into positions $(2,1)$ and $(3,1)$ --- the $L$ of $A=LU$.}
\end{extensionbox}
