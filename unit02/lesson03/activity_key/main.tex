...
\begin{work}
  -3(2,6)+(6,20) &= (0,2)
\end{work}
  \item Write $L$: put $1$s on the diagonal and the multiplier below. \; $L=\begin{bmatrix} 1 & 0 \\ {\color{keyred}\mathbf{3}} & 1 \end{bmatrix}$ \vspace{0.2cm}
...
\begin{work}
  ...
  2x+4+2 &= 10,\ x = 2
\end{work}
\ansline{$L$ is free: its entries are exactly the multipliers you compute \emph{anyway} while
eliminating --- you just write each one down instead of discarding it.}
\end{tcolorbox}
