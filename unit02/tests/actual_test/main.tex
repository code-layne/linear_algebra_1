...
% ../../test_keys/actual_test_key/main.tex. Here it ships as a \vphantom —
% exact height, no ink, nothing in the text layer — so the student gets precisely
% the room the answer needs and the two documents cannot drift in length.
% Edit a work block in BOTH files or in neither.
